...
class LengthTest {
	...
	@Test
	void testToInch() throws OperationFormatException {
	  Operand left;
	  Operand right;
	...
	@Test
	void testToFeet() throws OperationFormatException {
	  Operand left;
    Operand right;
	...
	@Test
	void testToYard() throws OperationFormatException {
	  Operand left;
    Operand right;
	...
	@Test
	void testToMile() throws OperationFormatException {
	  Operand left;
    Operand right;
	...
	@Test
	void testToMillimeter() throws OperationFormatException {
	  Operand left;
    Operand right;
	...
	@Test
	void testToCentimeter() throws OperationFormatException {
	  Operand left;
    Operand right;
	...
	@Test
	void testToMeter() throws OperationFormatException {
	  Operand left;
    Operand right;
	...
	@Test
	void testToKilometer() throws OperationFormatException {
	  Operand left;
    Operand right;
