...
public class WeightUtils {
	...
	public static BigDecimal toOunce(Operand op) {
		...
		switch (unit) {
			case "lb":
		      ...
		      case "g":
		    	// g to oz
		        value = value.divide(new BigDecimal(28.35), 6,
	...
	public static BigDecimal toPound(Operand op) {
		...
		switch (unit) {
			case "oz":
				// oz to lb
				value = value.divide(new BigDecimal(16.0), 6,
				        RoundingMode.HALF_DOWN);
		        break;
		      ...
		      case "g":
		    	// g to lb
		        value = value.divide(new BigDecimal(454.0), 6,
				        RoundingMode.HALF_DOWN);
		        break;
	...
	public static BigDecimal toTon(Operand op) {
		...
		switch (unit) {
			case "lb":
				// lb to ton
				value = value.divide(new BigDecimal(2000.0), 6,
				        RoundingMode.HALF_DOWN);
		        break;

		      case "oz":
		    	// oz to ton
		        value = value.divide(new BigDecimal(32000.0), 6,
				        RoundingMode.HALF_DOWN);
		        break;
		        
		      case "g":
		    	// g to ton
		        value = value.divide(new BigDecimal(907185.0), 6,
				        RoundingMode.HALF_DOWN);
		        break;

		      case "kg":
		    	// kg to ton
		        value = value.divide(new BigDecimal(907.0), 6,
				        RoundingMode.HALF_DOWN);
		        break;
		}
	...
	public static BigDecimal toKilogram(Operand op) {
		...
		switch (unit) {
			case "lb":
				// lb to kg
				value = value.divide(new BigDecimal(2.205), 6,
				        RoundingMode.HALF_DOWN);
		        break;

		      case "ton":
		    	// ton to kg
		        value = value.multiply(new BigDecimal(1016.05));
		        break;
		      ...
		      case "oz":
		    	// oz to kg
		        value = value.divide(new BigDecimal(35.274), 6,
				        RoundingMode.HALF_DOWN);
		        break;
		}
